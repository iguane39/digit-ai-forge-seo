/* VENDORED — copie verbatim, ne pas modifier ici.
   Source   : digit-ai-forge-organization/output/composant-filtres-tableau/assets/table-filters.js
   Copie le : 2026-08-08
   Motif    : le composant n'est pas installe dans digit-ai-page-html (son INSTALLATION.md
              attend un accord explicite, il touche deux skills en production). Decision D-12.
   Migration: des qu'il est installe, lire l'asset du skill au lieu de cette copie. Le HTML
              produit ne change pas — le contrat de marquage est identique.
*/
