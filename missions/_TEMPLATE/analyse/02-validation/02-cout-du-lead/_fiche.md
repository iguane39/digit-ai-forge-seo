...
source_requise: "CRM + dépenses média du client"
doublon_de: null
...
# Validation / Coût Du Lead

> Volet **STRATEGIE** -- statut **NM** (non mesurable -- motif obligatoire)

## Question d'audit

Combien coûte l'acquisition d'un lead sur ce marché ?

## Source requise

CRM + dépenses média du client

## Methode

déclaratif client, à reprendre en `[T2]`
