...
La structure d'URL et le maillage matérialisent-ils des silos thématiques ?
...
arbre d'URL + graphe de liens internes ; mesurer le taux de liens internes restant dans le même silo

## Critere de verdict

≥ 60 % des liens internes intra-silo
