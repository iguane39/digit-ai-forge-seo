...
# Architecture / Profondeur De Clic

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

À quelle profondeur se trouvent les pages à valeur ?
...
parcours en largeur depuis l'accueil ; profondeur minimale par URL

## Critere de verdict

0 page money > 3 clics **et** ≥ 90 % des pages à valeur ≤ 4 clics
