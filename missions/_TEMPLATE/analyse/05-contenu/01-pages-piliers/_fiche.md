...
# Contenu / Pages Piliers

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Chaque silo a-t-il une page pilier exhaustive et bien liée ?
...
pour chaque silo identifié au nœud 11, chercher la page la plus complète et la plus liée

## Critere de verdict

1 pilier par silo, couvrant le sujet de bout en bout, ≥ 5 liens sortants internes vers son silo
