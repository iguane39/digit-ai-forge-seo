...
source_requise: "déclaratif client"
doublon_de: null
...
Quelles tâches SEO sont déjà agentifiées chez le client ?
...
inventaire des automatisations existantes et de leur périmètre

## Critere de verdict

aucun — sert à calibrer le régime d'automatisation des actions
