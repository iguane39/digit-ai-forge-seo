...
source_requise: "déclaratif + observation"
doublon_de: null
...
# Optimisation / Tests SEO

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Le site a-t-il la capacité de tester une hypothèse SEO ?

## Source requise

déclaratif + observation

## Methode

vérifier l'existence de groupes de pages comparables et d'un moyen de mesurer l'écart

## Critere de verdict

capacité présente ou absente, avec le prérequis manquant nommé
