...
id: 16
branche: Mots Clés
noeud: Money Keywords
volet: TRANSVERSAL
statut_instrumentation: SD
source_requise: "cadrage + crawl (couverture) ; GSC (performance)"
doublon_de: null
...
# Mots Clés / Money Keywords

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Les requêtes à intention d'achat sont-elles couvertes par une page dédiée ?

## Source requise

cadrage + crawl (couverture) ; GSC (performance)

## Methode

croiser la liste des requêtes money du cadrage avec les pages existantes

## Critere de verdict

100 % des requêtes money ont une page dédiée
