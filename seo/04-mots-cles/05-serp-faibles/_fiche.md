...
source_requise: "SERP approximée"
doublon_de: null
...
# Mots Clés / SERP Faibles

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Quelles requêtes cibles ont une SERP attaquable ?
...
scorer la faiblesse du top 10 : présence de forums, pages fines, résultats hors intention, absence de page dédiée chez les concurrents

## Critere de verdict

≥ 3 signaux de faiblesse sur le top 10 = requête prioritaire
