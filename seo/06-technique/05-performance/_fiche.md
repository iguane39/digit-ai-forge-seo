...
source_requise: "données de terrain publiques (CrUX / PageSpeed Insights)"
doublon_de: null
...
Les métriques d'expérience de page sont-elles dans le vert sur données de terrain ?

## Source requise

données de terrain publiques (CrUX / PageSpeed Insights)

## Methode

relever les métriques de terrain sur les gabarits principaux, mobile en priorité

## Critere de verdict

seuils **à vérifier au run** — ne pas citer de métrique retirée du référentiel
