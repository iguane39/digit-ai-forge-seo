...
source_requise: "index de backlinks tiers (payant)"
doublon_de: null
...
> Volet **TRANSVERSAL** -- statut **PY** (instrumente si outil payant)

## Question d'audit

Quel est le profil de liens entrants du site ?

## Source requise

index de backlinks tiers (payant)

## Methode

relevé des domaines référents, de leur thématique et de leur qualité ; comparaison aux concurrents du cadrage

## Critere de verdict

aucun seuil absolu — comparaison relative aux concurrents uniquement
