...
# Signaux / Trafic Social

> Volet **ETAT** -- statut **EX** (instrumente si export fourni (GSC / GA / CRM))

## Question d'audit

Le contenu génère-t-il du trafic depuis les réseaux ?
...
part des sessions d'origine sociale

## Critere de verdict

aucun — descriptif. **La présence sociale est observable ; le trafic qu'elle génère ne l'est pas**
