...
# Discover / Signaux Externes

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Le contenu circule-t-il hors du site (reprises, citations, partages) ?
...
rechercher les reprises de titres et d'extraits ; relever les sources reprenant le contenu

## Critere de verdict

≥ 3 reprises hors agrégateurs automatiques
