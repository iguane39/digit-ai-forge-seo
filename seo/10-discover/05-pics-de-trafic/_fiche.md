...
# Discover / Pics De Trafic

> Volet **TRANSVERSAL** -- statut **EX** (instrumente si export fourni (GSC / GA / CRM))

## Question d'audit

Le site a-t-il connu des pics, et sur quoi ?

## Source requise

GSC / GA (séries temporelles)

## Methode

détecter les ruptures de série et les rattacher à une page ou un sujet

## Critere de verdict

aucun — diagnostic descriptif, sert à identifier ce qui fonctionne
