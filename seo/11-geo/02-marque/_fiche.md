...
La marque est-elle identifiable sans ambiguïté ?
...
rechercher le nom de marque seul ; détecter les homonymies et les entités concurrentes qui captent la requête

## Critere de verdict

le site occupe la première position sur son nom de marque, sans confusion d'entité
