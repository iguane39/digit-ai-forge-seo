...
source_requise: "crawl + recherche web"
doublon_de: null
...
Le contenu apporte-t-il une information non substituable ?
...
échantillon de 10 pages : chercher au moins un élément introuvable ailleurs (donnée propre, expérience vécue, méthode, chiffre original)

## Critere de verdict

≥ 60 % des pages de l'échantillon portent un élément non substituable
