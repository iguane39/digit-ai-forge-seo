...
# Automatisation / Génération De Pages

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Des pages sont-elles générées à l'échelle, et avec quel contrôle qualité ?
...
relier les motifs d'URL détectés au processus de génération déclaré ; identifier le point de contrôle qualité

## Critere de verdict

tout gabarit génératif a un contrôle qualité nommé avant publication
