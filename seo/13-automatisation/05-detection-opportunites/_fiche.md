...
# Automatisation / Détection Opportunités

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Existe-t-il un mécanisme de détection continue d'opportunités ?
...
vérifier l'existence d'une boucle : source de données → règle de détection → destinataire

## Critere de verdict

mécanisme présent ou absent ; s'il est absent, candidat prioritaire au quadrant `IA + gratuit`
