...
source_requise: "crawl (similarité) ; GSC pour confirmation"
doublon_de: null
...
# Optimisation / Pages À Fusionner

> Volet **TRANSVERSAL** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

Quelles pages se cannibalisent ?

## Source requise

crawl (similarité) ; GSC pour confirmation

## Methode

détecter les pages de sujet proche visant la même intention ; confirmer par GSC (même requête servie par deux URLs)

## Critere de verdict

0 paire de pages en cannibalisation confirmée
