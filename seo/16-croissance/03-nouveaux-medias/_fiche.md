...
# Croissance / Nouveaux Médias

> Volet **STRATEGIE** -- statut **SD** (instrumente sans dependance externe)

## Question d'audit

D'autres surfaces méritent-elles d'être investies (vidéo, podcast, place de marché) ?
...
vérifier si les SERP cibles affichent des formats que le site ne produit pas

## Critere de verdict

investissement justifié seulement si la SERP cible affiche déjà ce format
